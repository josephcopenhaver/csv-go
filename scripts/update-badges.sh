...
main() {
    rm -f coverage.out
    go test -coverprofile=coverage.out $(go list ./... | grep -vE '^(github\.com/josephcopenhaver/csv-go/internal/examples/|github\.com/josephcopenhaver/csv-go/internal/cmd/)')
